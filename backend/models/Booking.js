...
const bookingSchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    enum: ['pending', 'confirmed', 'rejected', 'cancelled', 'completed', 'expired', 'missed'],
    default: 'pending'
  },
  topic: {
    type: String,
  ...
  payment: {
    gateway: { type: String, enum: ['khalti', 'esewa', 'scan', null], default: null },
    status: { type: String, enum: ['unpaid', 'pending', 'paid', 'failed', 'refunded', 'partial_refund'], default: 'unpaid' },
    amount: { type: Number, default: 0 },
    transactionId: { type: String, default: null },
    scanProof: { type: String, default: null }, // base64 image for scan/QR payments
