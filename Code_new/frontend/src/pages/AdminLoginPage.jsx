      ...
      <div className="max-w-md mx-auto px-4 py-16">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <p className="text-center text-gray-600 mb-8">
            {showEmailLogin ? 'Sign in with your admin credentials' : 'Sign in with your authorized Google account'}
          </p>
          ...
          {(error || urlError) && (
            <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg mb-6">
              <div className="flex items-center">
                ...
                {error || (urlError === 'unauthorized' && 'Your email is not authorized for admin access') || 
            ...
            <>
              ...
              <div className="mt-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-left">
                  <p className="text-sm text-blue-800 font-medium mb-1">ℹ️ Authorization Required</p>
                  <p className="text-xs text-blue-700">
                    Only pre-authorized Gmail accounts can access the admin panel via Google OAuth. Or use your admin email/password credentials.
                  </p>
                </div>
              </div>
            </>
