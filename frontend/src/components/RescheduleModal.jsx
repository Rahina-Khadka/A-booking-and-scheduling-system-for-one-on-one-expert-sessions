    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-stone-900">Reschedule Session</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {date && (
            <div>
              <label className="block text-sm font-medium text-stone-700 mb-2">Available Slots</label>
              {loadingSlots ? (
                    ...
                    <button
                      ...
                      className={`px-3 py-2 rounded-lg text-sm border transition-colors ${
                        selectedSlot?.startTime === slot.startTime
                          ? 'bg-accent-600 text-white border-primary'
                          : 'bg-white text-stone-700 border-gray-300 hover:bg-stone-50'
                      }`}
                    >
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-2 border border-gray-300 rounded-lg text-stone-700 hover:bg-stone-50"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 bg-accent-600 text-white px-4 py-2 rounded-lg hover:bg-accent-700 disabled:bg-gray-400"
            >
