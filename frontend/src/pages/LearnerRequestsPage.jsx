      ...
      <div className="max-w-4xl mx-auto px-4 pt-24 pb-12">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{bookings.length} request{bookings.length !== 1 ? 's' : ''} awaiting expert response</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            <p className="text-sm text-gray-400 mb-6">When you book a session, it will appear here until the expert responds.</p>
              ...
              <motion.div key={b._id}
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-yellow-400 to-orange-400 flex items-center justify-center text-white font-bold flex-shrink-0 overflow-hidden">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="bg-yellow-100 text-yellow-700 text-xs font-semibold px-2.5 py-1 rounded-full">Awaiting</span>
