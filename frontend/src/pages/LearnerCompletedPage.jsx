      ...
      <div className="max-w-4xl mx-auto px-4 pt-24 pb-12">
        ...
        {loading ? (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            <p className="text-sm text-gray-400 mb-6">Book a session with an expert to get started.</p>
              ...
              <motion.div key={b._id}
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-indigo-400 flex items-center justify-center text-white font-bold flex-shrink-0 overflow-hidden">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="bg-blue-100 text-blue-700 text-xs font-semibold px-2.5 py-1 rounded-full">✓ Completed</span>
                    <Link to={`/experts/${b.expertId?._id}`}
                      className="text-xs text-indigo-600 font-medium hover:underline">View Expert</Link>
                  </div>
                </div>
              </motion.div>
            ))}
