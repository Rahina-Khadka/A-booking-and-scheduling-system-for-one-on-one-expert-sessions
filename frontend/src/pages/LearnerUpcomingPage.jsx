      ...
      <div className="max-w-4xl mx-auto px-4 pt-24 pb-12">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-stone-500">{bookings.length} session{bookings.length !== 1 ? 's' : ''} scheduled</p>
          </div>
        </div>
              ...
              <motion.div key={b._id}
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-emerald-600 flex items-center justify-center text-white font-bold flex-shrink-0 overflow-hidden">
