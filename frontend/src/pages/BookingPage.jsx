...
const BookingPage = () => {
  ...
  if (loading) return <div className="min-h-screen bg-gray-50"><Navbar /><div className="flex items-center justify-center h-96"><div className="w-10 h-10 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin" /></div></div>;

  if (error && !expert) return (
    <div className="min-h-screen bg-gray-50">
      <Navbar />
      <div className="max-w-3xl mx-auto px-4 pt-24 pb-8">
        <Link to="/experts" className="text-indigo-600 hover:underline mb-6 inline-block">← Back to Experts</Link>
        <div className="bg-white rounded-2xl shadow-sm border border-red-100 p-10 text-center">
          <div className="text-5xl mb-4">⚠️</div>
          <h2 className="text-xl font-bold text-gray-800 mb-2">Could not load expert</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Navbar />
      <div className="max-w-3xl mx-auto px-4 pt-24 pb-8">
        <Link to={`/experts/${expertId}`} className="text-indigo-600 hover:underline mb-6 inline-block">← Back to Expert Profile</Link>
